...
[RequireComponent(typeof(Collider))]
    ...
    public class TapToPlace1 : MonoBehaviour, IInputClickHandler
    {
        ...
        private void HandlePlacement()
        {
            ...
            else
            {
                ...
                Placed = true;
                surface.RemoveData();
                surface.transform.rotation = this.transform.rotation;
                surface.transform.position = this.transform.position;
